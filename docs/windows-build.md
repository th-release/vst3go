...
- `just windows-smoke` exercises the selector, preflight, packaging, and bundle-check scripts with fake toolchain shims so regressions can be caught on non-Windows hosts.

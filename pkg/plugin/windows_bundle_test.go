...
func TestWindowsBundlePaths(t *testing.T) {
	...
	if got, want := layout.HeaderPath, filepath.Join("dist/windows", "vst3go.vst3", "Contents", "x86_64-win", "vst3go.h"); got != want {
...
func TestWindowsBundlePathsDefaults(t *testing.T) {
	layout := WindowsBundlePaths("", "")
